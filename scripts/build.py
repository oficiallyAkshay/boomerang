...
.rsec{page-break-before:always;page-break-after:always;page-break-inside:auto;margin-top:56px}
.rhead{background:#111;color:#fff;padding:12px 16px;font-size:15px;font-weight:600;
border-radius:6px 6px 0 0}
.rc{border:1px solid #ddd;border-top:0;border-radius:0 0 6px 6px;padding:0.3in;overflow:auto;
width:fit-content;max-width:100%;margin:0 auto;box-sizing:border-box}
...
@media print{.page{padding:24px 24px 0}body{background:#fff}}
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"pages expected {pages}, one more for every page a receipt or the summary spills onto")
